    ...
    <style>
        * {
        ...
        .gallery-card img {
            ...
            height: 100%;
            object-fit: cover;
            /* Keep image cropped inside frame */
            cursor: pointer;
        ...
        @media (max-width: 480px) {
            ...
            .gallery-card {
                aspect-ratio: 4 / 3;
                display: block;
                /* Slightly rectangular on small screens */
            }
        }
    </style>
            ...
            <div class="container" style="max-width: 90%;">
                ...
                @if ($galary && count($galary) > 0)
                    <div class="row" id="galleryContainer">
                        @foreach ($galary as $g)
                            <div class="column gallery-item category-{{ $g->gallery_category_id ?? 'none' }}">
                                <div class="gallery-card">
                                    <img src="{{ asset('/setting/banner/' . $g->image) }}"
                                        alt="{{ $g->details ?? 'Gallery Image' }}" onclick="openPreview(this);">
                                </div>
                            </div>
                        @endforeach
                    </div>
